                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="well8">
                                ...
                                <form class="form-horizontal" method="post" name="regform" ng-controller="formController">
                                    <?php echo validation_errors(); ?>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input id="name" ng-model="name" name="name" type="text" placeholder="your name" class="form-control input-md" required="">
                                             <p ng-show="regform.name.$invalid && !regform.name.$pristine" class="help label-danger">You name is required.</p>
                                        </div>
                                        ...
                                        <div class="col-md-9">
                                            <select id="livein" name="livein" class="form-control" ng-model="country_list" ng-change="updateCountry()">
                                                ...
                                                <?php foreach ($countries as $row) { ?>
                                                    ...
                                                    <option data-country_code="<?php echo $row->code ?>" value="<?php echo $row->id ?>"><?php echo $row->name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
